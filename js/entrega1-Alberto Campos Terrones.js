...
const Producto = [
    { nombre: "Harry Popote", precio: 530 },
    { nombre: "El Diario del diablo", precio: 200 },
    { nombre: "Son del miedo", precio: 100 },
    { nombre: "El principito", precio: 220 },
    { nombre: "Constitucion", precio: 480 },
];
...
do {
    ...
    if (intUsuario == "si") {
        ...
        let seguir = prompt("Desea continuar el proceso?(Si/No)").toUpperCase
        if (seguir == "NO") {
            proceso = false;
        }
    }
